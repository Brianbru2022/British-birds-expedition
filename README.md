...
This phase keeps the clean GitHub Pages foundation and migrates more of the original prototype back in safely:
...
- Working expedition gear: binoculars, sonic sweep, thermal scope, golden lure, and guard shield.
- Working action cards: family reveal, double points, streak protection, remove wrong answers, redraw question, and gain binoculars.
...
1. Move the richer original bird-data fields into the GitHub build.
2. Add a dedicated shop/hub screen between rounds.
3. Move more round-specific UI into standalone components.
4. Add committed SVG or generated image assets for bird cards.
5. Reintroduce AI image/audio features on a Node-capable host such as Render, Railway, Fly.io, or Cloud Run.
6. Add unit tests for scoring, round setup, gear, and action cards.
